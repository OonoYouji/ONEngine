...
#pragma region"AttackAction"
	WeakAttack2Action::WeakAttack2Action(Enemy* enemy,float activeTime,float collisionStartTime,float collisionTime,float collisionRadius,float damage)
		:Action(enemy){
...
#pragma endregion
	...
	WeakAttack2::WeakAttack2(Enemy* enemy,WorkWeakAttack2Action* worker)
		:Sequence(enemy){
		// startup
		addChild(std::make_unique<TransitionAnimationWithWeapon>(enemy,/*"Boss_WeakAttack2_1_1"*/"Boss_StrongAttack_1_1",worker->motionTimes_.startupTime_,false));
		addChild(std::make_unique<WeakAttack2Startup>(enemy,worker->motionTimes_.startupTime_,worker->maxRotateY2Player_));

		// attackAction
		addChild(std::make_unique<TransitionAnimationWithWeapon>(enemy,/*"Boss_WeakAttack2_1_2"*/"Boss_StrongAttack_1_2",worker->motionTimes_.activeTime_,false));
		addChild(std::make_unique<WeakAttack2Action>(enemy,worker->motionTimes_.activeTime_,worker->collisionStartTime_,worker->collisionTime_,worker->collisionRadius_,worker->damage_));

		// end lag
		addChild(std::make_unique<TransitionAnimationWithWeapon>(enemy,/*"Boss_WeakAttack2_1_3"*/"Boss_StrongAttack_1_3",worker->motionTimes_.endLagTime_,false));
		addChild(std::make_unique<WeakAttack2EndLag>(enemy,worker->motionTimes_.startupTime_));
	}
