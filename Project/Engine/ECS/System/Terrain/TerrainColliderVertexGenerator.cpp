...
void TerrainColliderVertexGenerator::OutsideOfRuntimeUpdate(EntityComponentSystem* _ecs) {
...
void TerrainColliderVertexGenerator::RuntimeUpdate(EntityComponentSystem*) {
