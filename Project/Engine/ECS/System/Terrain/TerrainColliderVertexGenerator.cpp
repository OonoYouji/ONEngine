...
void TerrainColliderVertexGenerator::OutsideOfRuntimeUpdate(EntityComponentSystem* _ecs, const std::vector<class GameEntity*>&) {
...
void TerrainColliderVertexGenerator::RuntimeUpdate(EntityComponentSystem*, const std::vector<class GameEntity*>&) {
