...
void GizmoRenderingPipeline::Draw(class EntityComponentSystem*, [[maybe_unused]] const std::vector<GameEntity*>& _entities, CameraComponent* _camera, DxCommand* _dxCommand) {
