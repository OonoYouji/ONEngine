...
void CopyImageRenderingPipeline::Draw(class EntityComponentSystem*, [[maybe_unused]] const std::vector<GameEntity*>& _entities, [[maybe_unused]] CameraComponent* _camera, DxCommand* _dxCommand) {
