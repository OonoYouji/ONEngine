...
void CopyImageRenderingPipeline::Draw(class EntityComponentSystem* _ecs, [[maybe_unused]] const std::vector<IEntity*>& _entities, [[maybe_unused]] Camera* _camera, DxCommand* _dxCommand) {
